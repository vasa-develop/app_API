	...
	<div class="content">	
		<div class="module">
			<div class="module-head">
				<h3>Follower User List <a class="btn btn-mini btn-inverse pull-right" href="user_detail.php">Back</a></h3>
			</div>
...
function get_request_detail()
{
	...
	var dataTable = $('#data-grid').DataTable( 
	{
		...
		"ajax":
		{
			url :"follower_user_list_detail_grid_data.php", // json datasource
