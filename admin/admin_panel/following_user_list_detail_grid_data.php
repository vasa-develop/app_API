...
if($user_id!='')
{
	$user_query=" and lokaso_user_follow.follower='$user_id' ";
}
...
$query1= "SELECT lokaso_user_follow.*,lokaso_user.name,lokaso_user.email,lokaso_user.credits FROM `lokaso_user_follow` join lokaso_user on lokaso_user_follow.leader=lokaso_user.id where 1=1  and lokaso_user_follow.status=1 ".$user_query;
